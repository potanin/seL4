...
# Allow platforms to override PA size (e.g., orin-nano uses A72 proxy but only needs 40 bits)
if(DEFINED KernelPlatformPASizeBitsOverride)
    if(KernelPlatformPASizeBitsOverride EQUAL 40)
        set(KernelArmPASizeBits40 ON)
        set(KernelArmPASizeBits44 OFF)
        math(EXPR KernelPaddrUserTop "(1 << 40)")
    elseif(KernelPlatformPASizeBitsOverride EQUAL 44)
        set(KernelArmPASizeBits40 OFF)
        set(KernelArmPASizeBits44 ON)
        math(EXPR KernelPaddrUserTop "(1 << 44)")
    endif()
